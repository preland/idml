...
export const FlexDefSchema: z.ZodType<any> = z.lazy(() =>
  z
    .object({
      type: z.literal('flex'),
...
export const GridDefSchema: z.ZodType<any> = z.lazy(() =>
  z
    .object({
      type: z.literal('grid'),
...
export const LayoutDefSchema: z.ZodType<any> = z.discriminatedUnion('type', [
  FlexDefSchema,
  GridDefSchema,
]);
